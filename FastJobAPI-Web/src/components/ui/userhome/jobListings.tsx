...
export default function JobListings({ initialSection, onClose }: JobListingsProps) {
      ...
      <div className="bg-[#333] rounded-md overflow-hidden">
        ...
        >
          <div className="flex items-center space-x-4 text-white">
            ...
            <code className="text-sm text-gray-300">/auth/jobListings</code>
            <span className="text-white">채용 공고 보기</span>
          </div>
          {openSection === "user" ? (
