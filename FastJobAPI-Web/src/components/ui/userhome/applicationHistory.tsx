...
export default function ApplicationHistory({ initialSection, onClose }: ApplicationHistoryProps) {
      ...
      <div className="bg-[#333] rounded-md overflow-hidden">
        ...
        >
          <div className="flex items-center space-x-4 text-white">
            ...
            <code className="text-sm text-gray-300">/auth/applicationHistory</code>
            <span className="text-white">지원 한 회사 보기</span>
          </div>
          {openSection === "user" ? (
