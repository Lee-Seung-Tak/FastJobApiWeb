...
export default function KeyPoint() {
  ...
  const KeyPointsection = () => (
    <div className="bg-[#2c2c31] p-6 rounded-b-md">

      <div className="mx-auto bg-[#2c2c31] p-8 rounded-md border border-[#3a3a3a] space-y-6">
        {/* 핵심가치 1 */}
        <div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
      <div className='pt-5  justify-start text-white text-2xl font-normal font-pretendard'>
      ...
      <div className="bg-[#2c2c31] rounded-md overflow-hidden">
        ...
        >
          <div className="flex items-center space-x-4 text-white">
            <span className="px-3 py-1 bg-[#E37836] text-white rounded-md text-sm">
              핵심가치
            </span>
          </div>
          {openSection === "key" ? (
